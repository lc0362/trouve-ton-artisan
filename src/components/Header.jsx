...
<div className="loupe-menu">
                ...
                <form className="d-none d-lg-flex search-bar ms-3 ">
                    ...
                    />
                    <i className="bi bi-search icon-loupe-d"></i> {/* Icône Bootstrap pour la loupe */}
                ...
                <div className="collapse navbar-collapse" id="navbarNav">
                    <ul className="navbar-nav ms-lg-auto">
                        <li className="nav-item">
                            <Link className="nav-link mx-1" to="/batiment">Bâtiment</Link>
                        </li>
                        <li className="nav-item">
                            <Link className="nav-link mx-1" to="/services">Services</Link>
                        </li>
                        <li className="nav-item">
                            <Link className="nav-link mx-1" to="/fabrication">Fabrication</Link>
                        </li>
                        <li className="nav-item">
                            <Link className="nav-link mx-1" to="/alimentation">Alimentation</Link>
                        </li>
                    </ul>
                </div>
                </div>
